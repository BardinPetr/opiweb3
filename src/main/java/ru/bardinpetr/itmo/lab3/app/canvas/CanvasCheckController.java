...
public class CanvasCheckController extends JSRemoteController implements Serializable {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(CanvasCheckController.class);
    @Inject
    ...
    public void getPoints() {
        ...
        var src = repository.getAllPoints().stream().filter(i -> i.getTimestamp().atZone(ZoneId.systemDefault()).toEpochSecond() > timestamp).map(CanvasPointResult::of).toList();
