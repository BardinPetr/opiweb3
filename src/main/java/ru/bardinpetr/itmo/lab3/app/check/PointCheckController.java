...
public class PointCheckController implements Serializable {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(PointCheckController.class);
    @Inject
    ...
    public PointResult doCheck(PointCheckRequestDTO pointDTO, AreaConfigDTO areaDTO) {
        ...
        var status = areaPolygonController.getPredicate().test(point);
